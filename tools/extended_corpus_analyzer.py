...
ALREADY_ANALYZED = {
    'HT13', 'HT28', 'HT31', 'TY3a', 'ZA4', 'ZA15', 'KH5', 'KH88',
    'KNZf2', 'PH(?)31a', 'HT117', 'HT94', 'IOZa2', 'HT85a',
    'HT122a', 'HT122b', 'KH6', 'KH7a', 'PKZa11', 'ZA10b',
    'HT95a', 'SYZa4', 'KH11'
}
    ...
    def identify_new_findings(self) -> List[dict]:
        ...
        if kh_inscriptions:
            findings.append({
                ...
                'significance': 'ZERO K-R CONFIRMED' if kh_kuro == 0 and kh_kiro == 0 else 'UNEXPECTED K-R FOUND',
            })
...
def main():
    ...
    parser.add_argument('--batch', '-b', type=int, default=50, help='Number of inscriptions to analyze')
    parser.add_argument('--site', '-s', type=str, help='Filter to specific site')
    parser.add_argument('--all', '-a', action='store_true', help='Analyze all remaining inscriptions')

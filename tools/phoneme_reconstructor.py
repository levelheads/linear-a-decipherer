...
class PhonemeReconstructor:
    ...
    def __init__(self, verbose=False):
        ...
        self.results = {
            "metadata": {
                ...
                "principles": [
                    "P1 (Kober): Pattern-led analysis",
                    "P5 (Negative): Absence patterns",
                ],
            },
            "vowel_analysis": {},
            "consonant_analysis": {},
    ...
    def analyze_vowel_frequencies(self) -> dict:
        ...
        analysis["o_analysis"] = {
            ...
            "interpretation": "CONFIRMS non-Greek phonology"
            if o_pct < 10
            else "WEAKENS non-Greek hypothesis",
    ...
    def analyze_consonant_clusters(self) -> dict:
        ...
        for c in consonants:
            for v in vowels:
                ...
                if 0 < pct < 0.5:
                    rare.append(
                        {"cv": f"{c}{v}", "percentage": pct, "count": matrix[c][v]["count"]}
                    )
        ...
        if analysis["confirmed"]:
            analysis["word_final_consonants"] = [
                ...
                {"consonant": "-m", "confidence": "POSSIBLE", "evidence": "*118 distribution"},
                {
                    ...
                    "evidence": "Cross-linguistic common",
                },
            ]
    ...
    def analyze_phonotactics(self) -> dict:
        ...
        analysis = {
            ...
            "consonant_sequences": {
                "most_common": [
                    {"seq": s, "count": c} for s, c in consonant_sequences.most_common(20)
                ],
            },
            "constraints": [],
        }
    ...
    def build_phoneme_inventory(self) -> dict:
        ...
        vowels = {
            ...
            "o": {
                "status": "MARGINAL",
                "frequency": vowel_freqs.get("o", {}).get("percentage", 0),
...
def main():
    parser = argparse.ArgumentParser(description="Reconstruct Linear A phoneme inventory")
    parser.add_argument(
        "--vowel-matrix", action="store_true", help="Generate vowel frequency matrix"
    )
    parser.add_argument(
        "--consonant-clusters", action="store_true", help="Analyze consonant clusters"
    )

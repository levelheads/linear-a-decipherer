    ...
    def _build_index(self):
        ...
        self.volumes = {
            ...
            4: {
                ...
                'site_codes': ['ZA', 'IO', 'PE', 'PS', 'SY', 'AR', 'AP', 'CR', 'GR', 'KE', 'KT', 'MA', 'MI', 'PL', 'TH', 'TY'],
        ...
        ht_vol1 = [
            ...
            ('HT 13', 1, 42, 'tablet', 65, 5, 'complete', 'LM IB', True, True, ['ku-ro', 'ki-ro', 'te']),
            ...
            ('HT 28', 1, 88, 'tablet', 70, 5, 'complete', 'LM IB', True, True, ['ku-ro', 'te', 'su-pu']),
            ...
            ('HT 117', 1, 378, 'tablet', 75, 6, 'complete', 'LM IB', True, True, ['ku-ro', 'da-ma-te', 'a-ta-na']),
        ...
        za_inscriptions = [
            ...
            ('ZA 4', 4, 27, 'tablet', 65, 5, 'complete', 'LM IB', True, True, ['ku-ro', 'te', 'a-du']),
        ...
        religious_inscriptions = [
            ('IO Za 1', 4, 150, 'libation_table', 25, 2, 'complete', 'LM I', False, False, ['a-ta-i-*301-wa-ja']),
            ('IO Za 2', 4, 154, 'libation_table', 45, 3, 'complete', 'LM I', False, False, ['ja-sa-sa-ra-me', 'a-ta-i-*301-wa-ja']),
            ('IO Za 3', 4, 158, 'libation_table', 30, 2, 'fragmentary', 'LM I', False, False, []),
            ('IO Za 4', 4, 162, 'libation_table', 35, 2, 'complete', 'LM I', False, False, ['i-pi-na-ma']),
            ('IO Za 5', 4, 166, 'libation_table', 28, 2, 'complete', 'LM I', False, False, []),
            ('IO Za 6', 4, 170, 'libation_table', 40, 3, 'complete', 'LM I', False, False, ['u-na-ka-na-si']),
            ('PS Za 1', 4, 180, 'libation_table', 32, 2, 'complete', 'LM I', False, False, ['a-ta-i-*301-wa-ja']),
            ...
            ('SY Za 2', 4, 194, 'libation_table', 30, 2, 'complete', 'LM I', False, False, ['ja-sa-sa-ra-me']),
            ('PK Za 11', 4, 200, 'libation_table', 55, 4, 'complete', 'LM I', False, False, ['a-ta-i-*301-wa-ja', 'da-ma-te']),
        ...
        vol5_inscriptions = [
            ('KN Zf 2', 5, 150, 'scepter', 119, 2, 'complete', 'LM IB', True, True, ['a-ta-i-*301-wa-ja']),
        ...
        for entry in vol5_inscriptions:
            ...
            inscriptions[tablet_id] = {
                ...
                'has_logograms': logos,
                'key_sequences': seqs,
                'notes': 'KN Zf 2 is the 2024 Knossos ivory scepter (longest Linear A inscription)' if tablet_id == 'KN Zf 2' else ''
            }
...
def main():
    ...
    parser.add_argument('--volume', type=int, choices=[1, 2, 3, 4, 5],
                        help='List contents of a volume')
    ...
    parser.add_argument('--conventions', '-c', action='store_true',
                        help='Show transcription conventions')
    ...
    if args.lookup:
        ...
        for insc in inscriptions[:20]:
            print(f"  {insc['tablet_id']} (p.{insc['page']}) - {insc['inscription_type']}, {insc['sign_count']} signs")
        ...
        for insc in inscriptions[:20]:
            print(f"  {insc['tablet_id']} (Vol.{insc['volume']}, p.{insc['page']}) - {insc['sign_count']} signs")
        if len(inscriptions) > 20:
            print(f"  ... and {len(inscriptions) - 20} more")

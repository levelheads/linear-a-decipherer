...
class SigLAQuerier:
                ...
                "variants": [
                    {
                        "form": "standard",
                        "sites": ["HT", "KH"],
                        "description": "Open cross with central dot",
                    },
                ...
                "variants": [
                    {
                        "form": "standard",
                        "sites": ["HT", "KH"],
                        "description": "Vertical line with cross-bars",
                    },
                ],
                ...
                "variants": [
                    {
                        "form": "standard",
                        "sites": ["HT"],
                        "description": "Circular with internal elements",
                    },
                ],
                ...
                "variants": [
                    {
                        "form": "standard",
                        "sites": ["HT", "KH"],
                        "description": "U-shaped with internal stroke",
                    },
                ],
                ...
                "variants": [
                    {
                        "form": "standard",
                        "sites": ["HT", "KH"],
                        "description": "Arrow-like with stem",
                    },
                    {
                        "form": "elaborated",
                        "sites": ["PH"],
                        "description": "More complex arrow form",
                    },
                ],
                ...
                "variants": [
                    {
                        "form": "standard",
                        "sites": ["HT"],
                        "description": "Complex with internal lines",
                    },
                ],
                ...
                "variants": [
                    {
                        "form": "standard",
                        "sites": ["HT", "KH"],
                        "description": "Cross with additional elements",
                    },
                ...
                "variants": [
                    {
                        "form": "standard",
                        "sites": ["HT", "KH"],
                        "description": "Complex angular form",
                    },
                ],
                ...
                "variants": [
                    {
                        "form": "standard",
                        "sites": ["HT", "KH"],
                        "description": "Circular with internal dot",
                    },
                ],
                ...
                "variants": [
                    {
                        "form": "standard",
                        "sites": ["HT", "KH"],
                        "description": "Angular form with stem",
                    },
                ...
                "variants": [
                    {
                        "form": "standard",
                        "sites": ["HT", "KH"],
                        "description": "Berry cluster form",
                    },
                ],
                ...
                "variants": [
                    {
                        "form": "standard",
                        "sites": ["HT", "KH"],
                        "description": "Double-circle form",
                    },
                ],
                ...
                "variants": [
                    {
                        "form": "standard",
                        "sites": ["HT", "KH"],
                        "description": "Angular lightning-like",
                    },
                ],
    ...
    def compare_signs(self, sign_a: str, sign_b: str) -> Dict:
        ...
        if not entry_a or not entry_b:
            return {"error": f"Sign not found: {sign_a if not entry_a else sign_b}", "valid": False}
...
def main():
    ...
    parser.add_argument(
        "--query", "-q", type=str, help="Query a sign by AB number or phonetic value"
    )
    parser.add_argument("--variants", type=str, help="Get variants of a sign")
    parser.add_argument(
        "--compare",
        nargs=2,
        metavar=("SIGN_A", "SIGN_B"),

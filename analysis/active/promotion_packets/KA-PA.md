...
- Meaning claim: contested form; proto-Greek hypothesis currently eliminated
- Primary contexts: HT
...
- [x] cross_corpus_consistency (validated=True, positional=0.667, functional=0.750, sites=1, rule=min>=0.55 and max>=0.70)
